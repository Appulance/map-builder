...
Function PrintHeader()
    ...
    Print #1, "    <title>Map Builder (Excel 1.2)</title>"
    Print #1, "    <link rel=" + Chr$(34) + "stylesheet" + Chr$(34) + " href=" + Chr$(34) + "https://appulance.com/mapbuilder/mapbuilder.css" + Chr$(34) + ">"
    Print #1, "    <script src=" + Chr$(34) + "https://maps.googleapis.com/maps/api/js?key=AIzaSyABO4gHtCfuWR2UnLoecp7rZbkAWcDgsFg" + Chr$(34) + "></script>"
    Print #1, "    <script src=" + Chr$(34) + "https://code.jquery.com/jquery-3.5.1.min.js" + Chr$(34) + "></script>"
    Print #1, "    <script src=" + Chr$(34) + "https://appulance.com/mapbuilder/mapbuilder.js" + Chr$(34) + "></script>"
    Print #1, "    <script>"
...
'
    ...
    For Each Row In Selection.Rows
        ...
        Talkgroup = "Talkgroup: " & Trim(Row.Cells(, 6).Text) & "\n"
        Site = "Site: " & Trim(Row.Cells(, 7).Text) & "\n"
        FormattedLocationDT = Format(LocationDT, "yyyy-mm-ddTHH:mm:ss")
